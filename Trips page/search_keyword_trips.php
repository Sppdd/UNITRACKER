  ...
  <table class="table">
    ...
    <tbody>
      <?php 
        ...
        // $sql = "SELECT t_id ,t_s_time , t_e_time ,t_s_k ,t_e_k , t_direction  FROM trips_table WHERE t_direction LIKE '%". $keywordfromform ."%' ";
        // $result = $mysqli->query($sql);

        $sql = "SELECT  d_id , t_id ,t_s_time , t_e_time ,t_s_k ,t_e_k ,t_f, t_direction  FROM trip_table WHERE t_direction LIKE '%". $keywordfromform ."%' ";
        $result = $mysqli->query($sql);
